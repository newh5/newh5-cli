...
module.exports = {
    ...
    spritesOptions: {
        ...
        groupBy: function groupBy(image) {
            ...
            return groupName ? _promise2.default.resolve(groupName) : _promise2.default.reject();
        },
        // 非 img 子目录下面的 png 不合
        filterBy: function filterBy(image) {
            return (/img\/\S+\/\S+\.png$/.test(image.url) ? _promise2.default.resolve() : _promise2.default.reject()
            );
        }
    },
